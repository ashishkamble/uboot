...
#define CFG_MAX_FLASH_SECT	(263)	/* max number of sectors on one chip */
     ...
     defined (MT7628_FPGA_BOARD) || defined (MT7628_ASIC_BOARD)
        ...
        #define PHYS_FLASH_1		0xBC000000 /* Flash Bank #1 */
                ...
                #elif defined (ON_BOARD_64M_FLASH_COMPONENT)
                  #define PHYS_FLASH2_1		0xBE000000 /* Flash Bank #2 */
                #endif
...
#elif defined (ON_BOARD_64M_FLASH_COMPONENT)
#define CFG_KERN_SIZE		(0x2000000 - (CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_FACTORY_SIZE))
#endif
